...
public class Helpers {
	...
	public void launchNewProview() throws MalformedURLException, FileNotFoundException
	{
		...
		chromeOptions.addArguments("--no-sandboxdisable-gpu");
		...
		if(System.getProperty("Env").equalsIgnoreCase("ci")) {
			Driver.get().get("https://ci.proview.int.thomsonreuters.com");
			//driver.get("https://ci.proview.int.thomsonreuters.com");
		}else if(System.getProperty("Env").equalsIgnoreCase("demo")) {
			Driver.get().get("https://demo.proview.int.thomsonreuters.com");
			//driver.get("https://demo.proview.int.thomsonreuters.com");
		}
    }   
